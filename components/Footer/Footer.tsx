...
const Footer: React.FC<FooterProps> = ({ className = '' }) => {
  ...
  const socialLinks = [
    {
      href: 'https://twitter.com/digiclickai',
      label: 'Twitter',
      icon: (
    ...
    {
      href: 'https://linkedin.com/company/digiclickai',
      label: 'LinkedIn',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      href: 'https://github.com/digiclickai',
      label: 'GitHub',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className={styles.container}>
        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.brandSection}>
            <Link href="/" className={`${styles.footerLogo} glow-text`}>
            ...
            <div className={styles.socialLinks}>
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`${styles.socialLink} glow-trigger`}
          ...
          <div className={styles.linksGrid}>
            <div className={styles.linkSection}>
              ...
              <ul className={styles.linkList}>
                {footerLinks.company.map((link) => (
                  <li key={link.href}>
                    <Link href={link.href} className={`${styles.footerLink} nav-link`}>
                      {link.label}
                    </Link>
                  </li>
                ))}
            ...
            <div className={styles.linkSection}>
              ...
              <p className={styles.newsletterDescription}>
                Get the latest AI automation insights and updates.
              </p>
              <form className={styles.newsletterForm}>
                <input
                  ...
                  required
                />
                <button type="submit" className={`${styles.newsletterButton} cta-button`}>
                  Subscribe
                </button>
              </form>
            </div>
        ...
        <div className={styles.footerBottom}>
          <div className={styles.copyright}>
            <p>&copy; {currentYear} DigiClick AI. All rights reserved.</p>
          </div>
